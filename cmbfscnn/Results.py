...
class Plot_results(CMBFS_mode.Calculate_power_spectra):
    ...
    def plot_recovered_CMB_QU_PS(self, nlb=5):
        ...
        pt.plot_QQUU_PS(
            ell=pre_cmbQ_ps[0, 0, :],
            out_QQ=pre_cmbQ_ps[0, 1, :],
            tar_QQ=tar_cmbQ_ps[0, 1, :],
            out_UU=pre_cmbU_ps[0, 1, :],
            tar_UU=tar_cmbU_ps[0, 1, :],
            out_denoise_QQ=pre_denoise_Q_ps[0, 1, :],
            true_QQ=true_cmb_Q_ps[0, 1, :],
            out_denoise_UU=pre_denoise_U_ps[0, 1, :],
            true_UU=true_cmb_U_ps[0, 1, :],
        )
